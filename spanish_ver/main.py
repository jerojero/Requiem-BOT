...
NICK = "requiemSPA"
OWNER = "Puku"
OWNERVHOST = "Rizon-2ECDBF0D.va.us.panicbnc.net"
# Your vhost is unique so this way only you (identified) may be able to part and join channels.
INTRO = "Cada hora te entrega un tópico literario para pensar en tu existencia sin sentido. Escribe !!help para saber más."
...
# starts at the fourth element, first element (0) is the username, second (1) is PRIVMSG, third (2) is the channel and fourth is the first word (:!!firstword)
			...
			if(line[3] == ":!!help"):
				message = "Cada hora te entrega un tópico literario para pensar en tu existencia sin sentido, escribe !!topico para que te entregue uno ahora mismo. También puedes tener la explicación de un tópico particular con !!nombre del tópico (ej: !!carpe diem)."
